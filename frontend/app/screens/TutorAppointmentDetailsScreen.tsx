...
export default function TutorAppointmentDetailsScreen({ navigation, route }: any) {
  const studentName = route?.params?.studentName ?? 'Student Chinazom';
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <View style={styles.detailsCard}>
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailText}>
                Student: <Text style={styles.detailBold}>{studentName}</Text>
              </Text>
            </View>
            <View style={styles.detailRow}>
            ...
            {/* CTA — tutor sends reschedule to student */}
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() => { if (cancelReason.trim()) setSubmitted(true); }}
            disabled={submitted}
          >
