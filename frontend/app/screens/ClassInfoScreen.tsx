      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.detailsCard}>
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailText}>{otherPartyLabel}: <Text style={styles.detailBold}>{otherPartyName}</Text></Text>
          </View>
          <View style={styles.detailRow}>
...
const styles = StyleSheet.create({
  ...
  topBar: { flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', paddingHorizontal: 16, paddingTop: 20, paddingBottom: 10 },
